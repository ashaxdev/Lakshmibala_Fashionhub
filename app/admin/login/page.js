  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-brand-cream px-4">
      <form onSubmit={submit} className="card-soft p-8 w-full max-w-sm">
        <h1 className="font-display text-2xl font-bold text-brand-magenta text-center mb-1">LB Admin</h1>
        <p className="text-center text-sm text-brand-ink/50 mb-6">Lakshmibala Clothing Store</p>
        <input
          type="email"
          required
